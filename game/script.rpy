...
label day1:
    ...
    label event1_2: #Событие
            ...
            "Я покачал головой, продолжая смотреть в даль."
            ...
            "Достав пульт, диванный сыщик переключил канал с порядком надоевшего ему балета на криминальные передачи про расследования. Под голос детектива в комнату со сковородкой, на которой лежала мясная лазанья, уже наполняющая комнату сладким ароматом, зашла слегка сердитая Незабудка." 
            ...
            "Закинув голову назад, я увидел картину, что Борис уже заткнувшись лазаньей, уплетал ее большими ложками, сама сковорода стояла на одной из двух табуреток, взятых где-то, уже и не помню где. Коля присел на вторую и взял свою порцию, явно уступающую порции Бориса."
